...
class ContextEvaluatorHandler implements Handler
{
    ...
    public function handle(mixed $event, Context $context): array
    {
        ...
        $systemPrompt = "You are a context judge. Given a User Question and a set of Retrieves Memory/Context, decide if the Memory is sufficient to answer the question well. 
